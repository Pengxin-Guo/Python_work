...
f1=open("E:\Python\Python_work\python_scikit_learn\cluster_content.txt",'w',encoding='utf-8')
f2=open("E:\Python\Python_work\python_scikit_learn\cluster_id.txt",'w',encoding='utf-8')
